...
import { Award, Cloud, Brain, Database, Code, Network } from 'lucide-react';

const certifications = [
  {
    title: "Microsoft Copilot Course Completion",
  ...
  {
    title: "Data Platform Foundations Associate",
    issuer: "Oracle Cloud Infrastructure 2025",
    icon: Database,
    color: "purple"
  },
  ...
  {
    title: "Hands-on Supervised ML with Python",
    issuer: "Infosys Springboard",
    icon: Brain,
    color: "emerald"
  },
      ...
      <div className="max-w-6xl mx-auto px-6 relative">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto">
            30+ professional certifications covering Cloud Computing, AI/ML, Generative AI, Data Science, Python, API Development, and Enterprise Technologies
          </p>
        </div>
